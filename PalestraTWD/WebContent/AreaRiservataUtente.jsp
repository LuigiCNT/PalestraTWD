               ...
               <div class="container">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="500">Benvenuto!</h1>
               ...
               <div class="container">
                    <div class="row">
                            ...
                            <div class="col-lg-12 col-12 text-center mb-5">
                                ...
                                <h2 data-aos="fade-up" data-aos-delay="200">I tuoi Dati Personali</h2>
                             </div>
                                ...
                                <div class="class-thumb">
                                    ...
                                    <div class="class-info">
                                        <h3 class="mb-1">Scheda allenamento</h3>
                                           ...
                                           Visualizza Scheda di allenamneto                   
